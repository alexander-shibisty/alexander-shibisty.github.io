...
/**
 * Общие мелкие хелперы для провайдеров: угадывание MIME-типа и
 * "крупного" типа asset'а (image/video/audio/document/other) по
 * имени файла. Вынесено сюда, чтобы Dropbox/Local/будущие Google
 * Drive, OneDrive, S3 не дублировали одну и ту же таблицу
 * расширений.
 *
